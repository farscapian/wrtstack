...
| Task type | Files |
|-----------|-------|
| Build / flash / SD card | `cli.md`, `agentstartstack/ai-guidance/workflow.md` |
...
| Human Sync handoff | `agentstartstack/ai-guidance/nut.md`, `workflow.md` |